...
<body>
	<div class = "navbar navbar-default navbar-fixed-top">
		<label class = "navbar-brand">Patient Record In Fabella</label>			<?php
				$conn = new mysqli("localhost", "cdpqjbjgnr", "jtRvWu7a7A", "cdpqjbjgnr") or die(mysqli_error());
		...
		<br />
			...
			<div style = "float:left; width:30%;">
				...
				<div class = "group">
					...
					<textarea name = "chief_complaint" class = "form-control" style = "resize:none;"><?php echo $f ['chief_complaint']?></textarea>
				...
				<div class = "form-inline" style = "width:60%; margin-left:10px; margin-top:30px; float:left;">
					...
					<label>(</label>
					<input type = "text" name = "b1" disabled = "disabled" value = "<?php echo $f['b1']?>"  size = "2" class = "form-control" />
					<input type = "text" name = "b2" disabled = "disabled" value = "<?php echo $f['b2']?>"  size = "2" class = "form-control" />
					<input type = "text" name = "b3" disabled = "disabled" value = "<?php echo $f['b3']?>"  size = "2" class = "form-control" />
					<input type = "text" name = "b4" disabled = "disabled" value = "<?php echo $f['b4']?>"  size = "2" class = "form-control" />
					<label>)</label>
				</div>
				<br style = "clear:both;"/>
				<hr style = "border:1px solid #000;" />
