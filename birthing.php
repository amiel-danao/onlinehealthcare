		...
		<div class = "panel panel-default">
			...
			<div class = "panel-body">
				...
				<div class = "form-inline" style = "width:60%; margin-left:10px; margin-top:30px; float:left;">
					...
					<label>(</label>
					<input type = "text" name = "b1" size = "2" class = "form-control" />
					<input type = "text" name = "b2" size = "2" class = "form-control" />
					<input type = "text" name = "b3" size = "2" class = "form-control" />
					<input type = "text" name = "b4" size = "2" class = "form-control" />
					<label>)</label>
				</div>
				<br style = "clear:both;"/>
				<hr style = "border:1px solid #000;" />
