...
<html lang = "en">
	...
	<div class = "navbar navbar-default navbar-fixed-top">
		<img src = "" height = "55px" style = "float:left;"><label class = "navbar-brand">Patient Record In Fabella</label>
		...
		<div class = "panel panel-default">
			...
			<div class = "panel-body">
				...
				<div class = "form-group">
					...
					<input class = "form-control" type = "text" name = "chief_complaint" value = "<?php echo $f['chief_complaint'] ?>" disabled = "disabled" required = "required" />
					<br />
