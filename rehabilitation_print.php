...
<br />
	<div id="print">
		<div style = "margin:10px;">
			<img src = "" height = "100px" width = "100px" style = "float:left; position:relative; left:15%;" />
			<div style = "float:right; position:relative; right:35%;">
				<center><label>Republic of the Philippines</label></center>
			<center><label>Province of CAVITE</label></center>
			<center><label>CITY OF DASMARINAS</label></center>
