...
<br />
	<div id="print">
		<div style = "margin:10px;">
			<img src = "" height = "100px" width = "100px" style = "float:left; margin-left:90px; margin-top:-15px;"/>
			<div style = "margin-right:190px;">
				<label><center>REPUBLIKA ng PILIPINAS</center></label>
				<label><center>Cavite</center></label>
				<label><center>LUNGSOD NG CAVITE</center></label>
				<label><center>FABELLA HEALTH CENTER</center></label>
			</div>			<br />
			<br />
			<br />
			<br />
